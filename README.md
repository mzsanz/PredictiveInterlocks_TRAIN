# Poof of concept of predictive interlocks applied to the machine protection system for vacuum in particle accelerators and/or accelerator driven facilities: Training pipeline
